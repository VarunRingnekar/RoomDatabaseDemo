...
class AddFragment : Fragment() {
    ...
    //getting data from edit texts and uploading to database using viewModel
    private fun insertDataToDatabase(){
        ...
        if(inputCheck(firstName, lastName, age)){
            ...
            Toast.makeText(requireContext(), "Success! yay you added a user to the database!", Toast.LENGTH_SHORT).show()
            //navigate to list
    ...
    //checking if any of the edit texts were left empty
